...
##===== Data Options =====##
parser.add_argument('--mID',type=str, default='mouse735049',
                    help='mouse to perform analysis on')

parser.add_argument('--rec_name',type=str, default='aw_sal_2024-05-22_11-05-25',
...
if __name__ == '__main__':
    ...
    TempDir = os.path.join(ServDir,'results','kedm_rolling_RS_FS',mID,rec_name)
